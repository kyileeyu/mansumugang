...
<div class="result">
    ...
    <div class="result-item">
        <div class="depression-desc">
            ...
            - <strong src="https://www.nhis.or.kr/nhis/healthin/retrieveMindHltMelyMesr.d>">우울증 자가진단 사이트 클릭!</strong>
        </div>
...
export default {
  ...
  components: {
    ...
    methods:{
        ...
        getChimaiii(){
            axios.get('https://drkjhyuck.pythonanywhere.com/bluectr/?city_name=용인시')
            .then(res =>{
                console.log(res);
                console.log('우울증 성공!');
                })
