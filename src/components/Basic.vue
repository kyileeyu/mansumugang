...
<!--  -->
    ...
    <div class="result-info">
        ...
        <div class="result-item" v-if="selected.army == true" >
            <div class="info-title"><strong>군 복무 중 휴가 기간에 보험적용</strong></div>
            <div class="info-desc">
                <strong>대상</strong>: <strong class="col-red">군 복무 중 휴가 기간</strong>인 보험 적용 <strong class="col-red">현역병</strong><br>
                (육, 해, 공 현역병, 사관생도, 의무경찰, 의무소방대원, 해양의무경찰) <br><br>
                <strong>혜택 내용</strong>: 군 병원이 아닌 일반 요양 기관에서 건강보험으로 진료를 받을 경우 그 <strong class="col-red">치료비를 국가가 부담함</strong>.
                또한 가까운 동네 병원에서 치료가 불가능할 경우, 상급종합병원에서 치료 가능 상급종합병원에서 치료가 필요 시, 1차 치료를 했던 병원의 의사에게서 ‘요양급여의뢰서’를 발급 받아 건강 보험증과 함께 제출해야 함.
            </div>
        </div>
        <div class="result-item" v-if="info.age >= 19 ">
            <div class="info-title">치석제거 건강보험 적용</div>
            <div class="info-desc">
            <strong>대상</strong> : 만 19세 이상 (후속처치 없이 치서제거만으로 치료가 종료되는 환자) 
            <br><br>
            <strong>급여횟수</strong> : 연 1회
            </div>
        </div>
        <div class="result-item"  v-if="info.age >= 65 ">
            <div class="info-title">노인틀니 건강보험적용</div>
            <div class="info-desc">
            <strong>노인틀니 건강보험적용</strong><br>
                - <strong>완전틀니 대상</strong> : 만 65세 이상 (상악 또는 하악에 치아가 전혀 없는 경우) <br>
                - <strong>부분틀니 대상</strong> : 만 65세 이상 (상학 또는 하악의 치아결손으로 남은 치아를 이용하여 부분틀니 제작이 가능한 경우) <br>
                - <strong>본인부담률</strong> : <strong class="col-red">요양급여비용 총액의 30%</strong><br>
                - <strong>급여적용기간</strong> : 1악당 7년 <br>
                - <strong>무상보상기간</strong> : 틀니 장착 후, 3개월에 6회에 한하여 시술료 없이 진찰료만 산정 <br>
            </div>
        </div>
        
        <div class="result-item" v-if="selected.pragnant == true" >
            <div class="info-title">임신 출산 진료비 지원</div>
            <div class="info-desc">
                - <strong>출산비 </strong><br>
                -  <span class="col-red">'요양기관 이외의 장소'</span> + <span class="col-red">'2006년 11월 이후'</span> 출산한 경우 자녀 수에 상관없이 <span class="col-red">250,000원</span>을 지급함.<br>
                (* 요양기관 이외의 장소란? 병원, 의원, 조산원이 아닌 자택, 택시, 119 이송 중 분만한 경우)<br><br>
                - <strong>건강보험 진료비 지원제도</strong><br>
                - <strong>대상: </strong><span class="col-red">임산부</span>(임신 및 출산 관련 진료받은 급여+비급여 비중 중 본인이 부담한 금액)<br>
                                <span class="col-red">1세 미만 영유아</span> (요양기관에서의 진료비용 +약제 +치료 및 재료구입비용 금액)<br>
                - <strong>절차: </strong>지원신청서 발급 → 요양기관정보마당에 정보 입력 → 바우치신청 → 카드수령 후 1년까지 사용<br>
                - <strong>금액: </strong>임신 1회당 일태아 임산부는 60만원, 다태아 임산부는 100만원 <br>
                분만취약지의 경우 일태아 임산부는 80만원, 다태아 임산부는 120만원이 지원됨.<br>
            </div>
        </div>


        <div class="result-item" v-if="answerList[3] == 1">
            ...
            <div class="info-desc">
                ...
                - 지급절차: 가까운 공단 지사에 방문하거나 우편으로 접수하면 7일 이내에 지급<br>
                - 미지급대상: 근로복지공단 또는 보훈청 등으로부터 동일 유형의 보조기기를 지급받는 경우, 장애인등록일 이전에 구입한 경우, 구입일로부터 3년이 경과한 경우<br>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="location-list">
        <div class="location-list-item">
            <p>우울증 개선 센터  </p>
            >
            <router-link to="/depression" class="location-btn">
                위치보기
            </router-link>
        </div>
        <div class="location-list-item">
